(function() {
  describe('VideoAlpha', function() {
    ...
    // NEW TEST FROM THE JS FILES IN spec/videoalpha/display
    
    //From former HTML5Video.js
    describe('HTML5 Video: click', function() {
      describe('when player is paused', function() {
        beforeEach(function() {
          ...
          state.videoPlayer.player.playerState = 2;
        ...
        it('player state was changed', function() {
          ...
          runs(function() {
            expect(state.videoPlayer.player.getPlayerState()).toBe(1);
          });
        });
      ...
      describe('when player is played', function() {
        beforeEach(function() {
          ...
          spyOn(state.videoPlayer.player, 'callStateChangeCallback').andCallThrough();
          state.videoPlayer.player.playerState  = 1;
          $(state.videoPlayer.player.videoEl).trigger('click');
        });
        ...
        it('player state was changed', function() {
          waitsFor(function() {
            return state.videoPlayer.player.getPlayerState() !== 1;
          }, 'Player state should be changed', 1000);
          runs(function() {
            expect(state.videoPlayer.player.getPlayerState()).toBe(2);
          });
        });
    ...
    describe('HTML5 Video: play', function() {
      beforeEach(function() {
        loadFixtures('videoalpha_html5.html');
        state = new VideoAlpha('#example');
        spyOn(state.videoPlayer.player.video, 'play').andCallThrough();
    ...
    describe('HTML5 Video: pause', function() {
      beforeEach(function() {
        loadFixtures('videoalpha_html5.html');
        state = new VideoAlpha('#example');
        spyOn(state.videoPlayer.player.video, 'pause').andCallThrough();
    ...
    describe('HTML5 Video: canplay', function() {
      beforeEach(function() {
        loadFixtures('videoalpha_html5.html');
        state = new VideoAlpha('#example');
        spyOn(state.videoPlayer, 'onReady').andCallThrough();
        waitsFor(function() {
          return state.videoPlayer.player.getPlayerState() !== -1;
      ...
      it('end property was defined', function() {
        runs(function() {
          expect(state.videoPlayer.player.end).not.toBeNull();
        });
      });
      ...
      it('start position was defined', function() {
        runs(function() {
          expect(state.videoPlayer.player.video.currentTime).toBe(state.videoPlayer.player.start);
        });
      });
    ...
    describe('HTML5 Video: ended', function() {
      beforeEach(function() {
        loadFixtures('videoalpha_html5.html');
        state = new VideoAlpha('#example');
        spyOn(state.videoPlayer.player, 'callStateChangeCallback').andCallThrough();
      ...
      it('player state was changed', function() {
        runs(function() {
          jasmine.fireEvent(state.videoPlayer.player.videoEl, "ended");
          expect(state.videoPlayer.player.getPlayerState()).toBe(2);
        });
      });
