define(["backbone", "underscore", "underscore.string", "jquery", "gettext", "js/models/file_upload", "js/views/upload_dialog"],
    ...
    var EditChapter = Backbone.View.extend({
        ...
        openUploadDialog: function(e) {
            ...
            var view = new UploadDialogView({model: msg, chapter: this.model});
